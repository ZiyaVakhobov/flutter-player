...
struct TvCategories{
    ...
    static func fromMap(map : [String:Any])-> TvCategories{
        return TvCategories(id: (map["id"] as? String),title: map["title"] as? String)
    }
}
